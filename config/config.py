...
API_ID = int(getenv("API_ID", "15681317"))
API_HASH = getenv("API_HASH", "3470f2315d0644816de374a0e0fbd997")

## Get it from @Botfather in Telegram.
BOT_TOKEN = getenv("BOT_TOKEN", "5427580834:AAEDBMnZ_73EcxHy-mf_JbEovEchijc_GCw")
...
LOG_GROUP_ID = int(getenv("LOG_GROUP_ID", "-1001833576246"))

# A name for your Music bot.
MUSIC_BOT_NAME = getenv("MUSIC_BOT_NAME","Sypher Music")

# Your User ID.
OWNER_ID = list(
    map(int, getenv("OWNER_ID", "1876529696").split())
